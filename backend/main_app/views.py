...
OLD_ASSISTANT_SALARIES = [
    96785, 89340, 74450, 74450, 74450,
]

OLD_TEACHER_SALARIES = [
    109986, 93065, 84605, 84605, 84605,
]

OLD_TEACHER_K_N_SALARIES = [
    121824, 117312, 99264, 90240, 90240,
]

OLD_DOCENT_K_N_SALARIES = [
    142130, 121826, 111674, 101522, 101522,
]

ASSISTANT_SALARIES = [
    101621, 93804, 78170, 78170, 78170,
]

TEACHER_SALARIES = [
    115485, 97718, 88835, 88835, 88835,
]

TEACHER_K_N_SALARIES = [
    127912, 123175, 104225, 94750, 94750,
]

DOCENT_K_N_SALARIES = [
    149240, 127920, 117260, 106600, 106600,
]
